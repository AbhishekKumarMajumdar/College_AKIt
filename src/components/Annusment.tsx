    ...
    return (
        <>
            <div className="flex justify-evenly py-10 mmm flex-row">
                ...
                <a href="https://online.uktech.ac.in/ums/Student/Public/ViewDetail"><div className={`w-[18vw] h-[10vw] rounded-[1.5vw] cursor-pointer flex justify-center items-center flex-col bg-[#7A838A]`}><BsPersonRaisedHand color='#fff' size={80} className='w-[14vw] h-[14vw] mx-2' />
                    <p className='text-white font-semibold text-[2vw]'>Student Attendance</p></div></a>
