            ...
            <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-10">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 justify-items-center">
                    ...
                    >
                                ...
                                <ul className="flex justify-center flex-col gap-6 mt-8 mx-auto md:gap-2">
                                    <li>
                                        <a
                                            ...
                                            target="_blank"
                                            className="text-gray-400 transition hover:text-white/75 flex"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="https://www.instagram.com/akit_tanakpur_2016?igsh=cGF1cmVyMzNib2c0"
                                            rel="noopener noreferrer"
                                            target="_blank"
                                            className="text-gray-400 transition hover:text-white/75 flex"
                                        >
                                    ...
                                    <li>
                                        <a
                                            href="https://youtube.com/@apjabdulkalaminstituteofteofte5453?si=ohwlWAE5ucamEPR"
                                            rel="noopener noreferrer"
                                            target="_blank"
                                            className="text-gray-400 transition flex hover:text-white/75"
                                        >
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <nav className="mt-8">
                                <ul className="space-y-4 text-sm">
                                    <li>
                                        <a className=" text-gray-400 transition hover:text-white/75" href="/">
                                            Careers
                                        </a>
                                    </li>
                        ...
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium text-white">Parents</p>
                ...
                <div className="pt-6 mt-12 border-t border-gray-800">
                    <p className="text-sm text-center text-gray-400 justify-center items-center">
                        Copyright © 2023 | All Rights Reserved | Dr. APJ Abdul Kalam Institute of Technology, Tanakpur
                    </p>
                </div>
            </div>
        </footer>
